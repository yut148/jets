describe Jets::Builders::ShimVars::App do
  context "controller without namespace" do
    ...
    it "deduces info for node shim" do
      ...
      expect(vars.dest_path).to eq "handlers/controllers/posts_controller.js"
  ...
  context "controller with namespace" do
    ...
    it "deduces info for node shim" do
      ...
      expect(vars.dest_path).to eq "handlers/controllers/admin/pages_controller.js"
  ...
  context "job" do
    ...
    it "deduces info for node shim" do
      ...
      expect(vars.dest_path).to eq "handlers/jobs/hard_job.js"
  ...
  context "function without _function" do
    ...
    it "deduces info for node shim" do
      ...
      expect(vars.dest_path).to eq "handlers/functions/hello.js"
  ...
  context "function with _function" do
    ...
    it "deduces info for node shim" do
      ...
      expect(vars.dest_path).to eq "handlers/functions/simple_function.js"
